...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m.__track_lines__[360] = 'pyjamas.DOM.py, line 2:\n    # ... def eventGetButton(evt):';
	...
	$m.__track_lines__[1025] = 'pyjamas.DOM.py, line 57:\n    if item is None: ... def eventGetMouseWheelVelocityY(evt):';
