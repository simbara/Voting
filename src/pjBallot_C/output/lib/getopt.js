...
$pyjs.loaded_modules['getopt'] = function (__mod_name__) {
	...
	$m['getopt'] = function(args, shortopts, longopts) {
		...
		return args.__getitem__(0)['startswith']('-');
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_9_err){if (!$p['isinstance']($pyjs_dbg_9_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_9_err);}throw $pyjs_dbg_9_err;
}})())?!$p['op_eq'](args.__getitem__(0), '-'):$and2):$and1));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_10_err){if (!$p['isinstance']($pyjs_dbg_10_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_10_err);}throw $pyjs_dbg_10_err;
}})()) {
			$pyjs.track.lineno=85;
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']($p['op_eq'](args.__getitem__(0), '--'));
			...
			return args.__getitem__(0)['startswith']('--');
				...
				return (typeof do_longs == "undefined"?$m.do_longs:do_longs)(opts, $p['__getslice'](args.__getitem__(0), 2, null), longopts, $p['__getslice'](args, 1, null));
				...
				return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
				return (typeof do_shorts == "undefined"?$m.do_shorts:do_shorts)(opts, $p['__getslice'](args.__getitem__(0), 1, null), shortopts, $p['__getslice'](args, 1, null));
	...
	$m['gnu_getopt'] = function(args, shortopts, longopts) {
		...
		while ((function(){try{try{$pyjs.in_try_except += 1;
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']($p['op_eq']($p['__getslice'](args.__getitem__(0), 0, 2), '--'));
				...
				return $p['bool']($p['op_eq']($p['__getslice'](args.__getitem__(0), 0, 1), '-'));
				...
				if ((function(){try{try{$pyjs.in_try_except += 1;
					...
					(function(){try{try{$pyjs.in_try_except += 1;
					return prog_args['append'](args.__getitem__(0));
	...
	$m['do_longs'] = function(opts, opt, longopts, args) {
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			...
			return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
			return $p['tuple']([$p['__getslice'](opt, 0, i), $p['__getslice'](opt, $p['__op_add']($add5=i,$add6=1), null)]);
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				...
				return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
				return $p['tuple']([args.__getitem__(0), $p['__getslice'](args, 1, null)]);
	...
	$m['do_shorts'] = function(opts, optstring, shortopts, args) {
		...
		while ((function(){try{try{$pyjs.in_try_except += 1;
			...
			return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
			return $p['tuple']([optstring.__getitem__(0), $p['__getslice'](optstring, 1, null)]);
