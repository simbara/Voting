...
$pyjs.loaded_modules['pyjamas.Location'] = function (__mod_name__) {
	...
	$m.__track_lines__[74] = 'pyjamas.Location.py, line 74:\n    search = self.getSearch()[1:]';
	...
	$m['makeUrlDict'] = function(urlstring) {
		...
		while (typeof($p['__wrapped_next']($iter1_nextval).$nextval) != 'undefined') {
			...
			return dict.__setitem__(kv.__getitem__(0), kv.__getitem__(1));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getHashDict', function() {
			...
			return self['getHash']();
				...
				self.hashDictHash = (function(){try{try{$pyjs.in_try_except += 1;
				return self['getHash']();
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_16_err){if (!$p['isinstance']($pyjs_dbg_16_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_16_err);}throw $pyjs_dbg_16_err;
}})();
				$pyjs.track.lineno=36;
				self.hashDict = (function(){try{try{$pyjs.in_try_except += 1;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearch', function() {
			...
			$pyjs.track.lineno=67;
			var $pyjs__ret = $p['__op_add']($add5='',$add6=$p['getattr']($p['getattr'](self, 'location'), 'search'));
			$pyjs.trackstack.pop();$pyjs.track=$pyjs.trackstack.pop();$pyjs.trackstack.push($pyjs.track);
			return $pyjs__ret;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearchDict', function() {
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']((function(){try{try{$pyjs.in_try_except += 1;
			return $p['isinstance']($p['getattr'](self, 'location'), $p['basestring']);
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](!$p['bool']($p['getattr'](self, 'searchDict')));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_28_err){if (!$p['isinstance']($pyjs_dbg_28_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_28_err);}throw $pyjs_dbg_28_err;
}})()) {
				$pyjs.track.lineno=73;
				self.searchDict = (function(){try{try{$pyjs.in_try_except += 1;
				return $p['dict']([]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearchVar', function(key) {
			...
			searchDict = (function(){try{try{$pyjs.in_try_except += 1;
