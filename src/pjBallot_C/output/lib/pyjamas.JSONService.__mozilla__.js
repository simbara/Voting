...
$pyjs.loaded_modules['pyjamas.JSONService'] = function (__mod_name__) {
	...
	$m.__track_lines__[148] = 'pyjamas.JSONService.py, line 3:\n    #     http://groups.google.com/group/json-rpc/web/json-rpc-1-1-wd ... def create_object(items):';
	$m.__track_lines__[168] = 'pyjamas.JSONService.py, line 7:\n    """ JSONService is a module providing JSON RPC Client side proxying. ... def _decode_response(json_str):';
	...
	, 1, [null,null,['self'],['url'],['methods', null],['headers', null]]);
		...
		$method = $pyjs__bind_method2('_registerMethods', function(methods) {
			...
			var $iter1_nextval,$iter1_type,$iter1_idx,$iter1_iter,$iter1_array,$pyjs__trackstack_size_1,method;
