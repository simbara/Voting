...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m.__track_lines__[78] = 'pyjamas.DOM.py, line 17:\n    """ ... def init():';
	...
	$m.__track_lines__[231] = 'pyjamas.DOM.py, line 2:\n    # ... def buttonClick(element):';
	$m.__track_lines__[238] = 'pyjamas.DOM.py, line 13:\n    # limitations under the License. ... def compare(elem1, elem2):';
	...
	$m.__track_lines__[294] = 'pyjamas.DOM.py, line 118:\n    listener = None ... def createInputRadio(group):';
	...
	$m.__track_lines__[360] = 'pyjamas.DOM.py, line 32:\n    from pyjamas.ui import Event ... def eventGetButton(evt):';
	...
	$m.__track_lines__[407] = 'pyjamas.DOM.py, line 137:\n    if listener is not None: ... def eventGetTarget(event):';
	$m.__track_lines__[411] = 'pyjamas.DOM.py, line 142:\n     ... def eventGetToElement(evt):';
	$m.__track_lines__[420] = 'pyjamas.DOM.py, line 26:\n     ... def eventGetType(event):';
	...
	$m.__track_lines__[439] = 'pyjamas.DOM.py, line 147:\n    listener = get_listener(cap) ... def eventToString(evt):';
	$m.__track_lines__[443] = 'pyjamas.DOM.py, line 443:\n    def iframeGetSrc(elem):';
	$m.__track_lines__[444] = 'pyjamas.DOM.py, line 444:\n    return elem.src';
	$m.__track_lines__[447] = 'pyjamas.DOM.py, line 66:\n    def set_listener(item, listener): ... def getAbsoluteLeft(elem):';
	$m.__track_lines__[461] = 'pyjamas.DOM.py, line 114:\n    sender = get_main_frame().gobject_wrap(sender) # webkit HACK! ... def getAbsoluteTop(elem):';
	...
	$m.__track_lines__[505] = "pyjamas.DOM.py, line 194:\n    if et == 'mouseout': ... def getChild(elem, index):";
	$m.__track_lines__[513] = 'pyjamas.DOM.py, line 513:\n    if child.nodeType == 1:';
	$m.__track_lines__[518] = 'pyjamas.DOM.py, line 518:\n    return None';
	$m.__track_lines__[521] = 'pyjamas.DOM.py, line 214:\n    def addEventPreview(preview): ... def getChildCount(elem):';
	...
	$m.__track_lines__[535] = 'pyjamas.DOM.py, line 136:\n    listener = get_listener(curElem) ... def getChildIndex(parent, toFind):';
	...
	$m.__track_lines__[577] = 'pyjamas.DOM.py, line 269:\n    return createElement("form") ... def getFirstChild(elem):';
	...
	$m.__track_lines__[591] = 'pyjamas.DOM.py, line 283:\n     ... def getInnerText(element):';
	...
	$m.__track_lines__[739] = 'pyjamas.DOM.py, line 156:\n    #print "cap", evt, cap ... def isOrHasChild(parent, child):';
	$m.__track_lines__[751] = 'pyjamas.DOM.py, line 183:\n    try: ... def releaseCapture(elem):';
	...
	$m.__track_lines__[867] = 'pyjamas.DOM.py, line 503:\n     ... def setInnerText(elem, text):';
	...
	$m.__track_lines__[948] = 'pyjamas.DOM.py, line 203:\n     ... def sinkEventsMozilla(element, bits):';
	$m.__track_lines__[951] = 'pyjamas.DOM.py, line 550:\n    return -1 ... def toString(elem):';
	...
	$m.__track_lines__[1007] = "pyjamas.DOM.py, line 592:\n    # To mimic IE's 'innerText' property in the W3C DOM, we need to recursively ... def insertListItem(select, item, value, index):";
	...
	$m.__track_lines__[1025] = "pyjamas.DOM.py, line 198:\n    et == 'keypress' or et == 'change'): ... def eventGetMouseWheelVelocityY(evt):";
...
element['on'+event_name] = null
	...
	$m['insertListItem'] = function(select, item, value, index) {
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool']($p['op_eq'](index, (typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1))));
