...
$pyjs.loaded_modules['base64'] = function (__mod_name__) {
...
}})(), 0, (typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1)));
		$pyjs.track.lineno=64;
		if ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool']((altchars !== null));
			...
			return $p['dict']([['+', altchars.__getitem__(0)], ['/', altchars.__getitem__(1)]]);
	...
	return $p['dict']([[0, 'A'], [9, 'J'], [18, 'S'], [27, '3'], [1, 'B'], [10, 'K'], [19, 'T'], [28, '4'], [2, 'C'], [11, 'L'], [20, 'U'], [29, '5'], [3, 'D'], [12, 'M'], [21, 'V'], [30, '6'], [4, 'E'], [13, 'N'], [22, 'W'], [31, '7'], [5, 'F'], [14, 'O'], [23, 'X'], [6, 'G'], [15, 'P'], [24, 'Y'], [7, 'H'], [16, 'Q'], [25, 'Z'], [8, 'I'], [17, 'R'], [26, '2']]);
	...
	$m['b32encode'] = function(s) {
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			...
			return ''['ljust']($p['__op_sub']($sub1=5,$sub2=leftover), '\x00');
		...
		while (typeof($p['__wrapped_next']($iter6_nextval).$nextval) != 'undefined') {
			...
			return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
			return $m['struct']['unpack']('!HHB', $p['__getslice'](s, (typeof ($mul1=i)==typeof ($mul2=5) && typeof $mul1=='number'?
				$mul1*$mul2:
			...
			return $p['list']([$m['_b32tab'].__getitem__((c1)>>(11)), $m['_b32tab'].__getitem__(((c1)>>(6))&(31)), $m['_b32tab'].__getitem__(((c1)>>(1))&(31)), $m['_b32tab'].__getitem__((c2)>>(12)), $m['_b32tab'].__getitem__(((c2)>>(7))&(31)), $m['_b32tab'].__getitem__(((c2)>>(2))&(31)), $m['_b32tab'].__getitem__((c3)>>(5)), $m['_b32tab'].__getitem__((c3)&(31))]);
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool']($p['op_eq'](leftover, 1));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_51_err){if (!$p['isinstance']($pyjs_dbg_51_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_51_err);}throw $pyjs_dbg_51_err;
}})()) {
			$pyjs.track.lineno=177;
			$pyjs.track.lineno=177;
			var $pyjs__ret = $p['__op_add']($add13=$p['__getslice'](encoded, 0, (typeof ($usub2=6)=='number'?
				-$usub2:
			...
			return $p['bool']($p['op_eq'](leftover, 2));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_52_err){if (!$p['isinstance']($pyjs_dbg_52_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_52_err);}throw $pyjs_dbg_52_err;
}})()) {
			$pyjs.track.lineno=179;
			$pyjs.track.lineno=179;
			var $pyjs__ret = $p['__op_add']($add15=$p['__getslice'](encoded, 0, (typeof ($usub3=4)=='number'?
				-$usub3:
			...
			return $p['bool']($p['op_eq'](leftover, 3));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_53_err){if (!$p['isinstance']($pyjs_dbg_53_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_53_err);}throw $pyjs_dbg_53_err;
}})()) {
			$pyjs.track.lineno=181;
			$pyjs.track.lineno=181;
			var $pyjs__ret = $p['__op_add']($add17=$p['__getslice'](encoded, 0, (typeof ($usub4=3)=='number'?
				-$usub4:
			...
			return $p['bool']($p['op_eq'](leftover, 4));
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_54_err){if (!$p['isinstance']($pyjs_dbg_54_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_54_err);}throw $pyjs_dbg_54_err;
}})()) {
			$pyjs.track.lineno=183;
			$pyjs.track.lineno=183;
			var $pyjs__ret = $p['__op_add']($add19=$p['__getslice'](encoded, 0, (typeof ($usub5=1)=='number'?
				-$usub5:
	...
	$m['b32decode'] = function(s, casefold, map01) {
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool']($p['op_eq'](padchars, 0));
			...
			return $p['bool']($p['op_eq'](padchars, 1));
			...
			return $p['bool']($p['op_eq'](padchars, 3));
			...
			return $p['bool']($p['op_eq'](padchars, 4));
			...
			return $p['bool']($p['op_eq'](padchars, 6));
	...
	$m['test'] = function() {
		...
		try {
			try {
				...
				return $p['__ass_unpack']((function(){try{try{$pyjs.in_try_except += 1;
				return getopt['getopt']($p['__getslice']($p['getattr'](sys, 'argv'), 1, null), 'deut');
			...
			if (($pyjs_try_err_name == $p['getattr'](getopt, 'error').__name__)||$p['_isinstance']($pyjs_try_err,$p['getattr'](getopt, 'error'))) {
				...
				return $p['sprintf']("usage: %s [-d|-e|-u|-t] [file|-]\n        -d, -u: decode\n        -e: encode (default)\n        -t: encode and decode string 'Aladdin:open sesame'", $p['getattr'](sys, 'argv').__getitem__(0));
