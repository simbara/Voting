...
$pyjs.loaded_modules['pyjamas.ui.UIObject'] = function (__mod_name__) {
	...
	$m['findStyleName'] = function(element, style) {
		...
		while ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool'](!$p['op_eq'](idx, (typeof ($usub2=1)=='number'?
			-$usub2:
			$p['op_usub']($usub2))));
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](($p['bool']($or1=$p['op_eq'](idx, 0))?$or1:$p['op_eq'](oldStyle.__getitem__($p['__op_sub']($sub1=idx,$sub2=1)), ' ')));
			...
			idx = (function(){try{try{$pyjs.in_try_except += 1;
			return oldStyle['find'](style, $p['__op_add']($add3=idx,$add4=1));
	...
	$m['setStyleName'] = function(element, style, add) {
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']($p['op_eq'](idx, (typeof ($usub3=1)=='number'?
				-$usub3:
				$p['op_usub']($usub3))));
		...
		if ((function(){try{try{$pyjs.in_try_except += 1;
			return $p['bool']($p['op_eq'](idx, (typeof ($usub4=1)=='number'?
			-$usub4:
			$p['op_usub']($usub4))));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setPixelSize', function(width, height) {
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](((($p['cmp'](width, 0))|1) == 1));
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](((($p['cmp'](height, 0))|1) == 1));
...
}})(), (eventBitsToAdd)|((function(){try{try{$pyjs.in_try_except += 1;
...
}})(), (~(eventBitsToRemove))&((function(){try{try{$pyjs.in_try_except += 1;
			return $m['DOM']['getEventsSunk']((function(){try{try{$pyjs.in_try_except += 1;
			return self['getElement']();
