...
$pyjs.loaded_modules['pjBallot'] = function (__mod_name__) {
	...
	$m['pjBallot'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$pyjs.track={module:'pjBallot', lineno:31};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=31;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('nextContest', function() {
			...
			var $add2,$add1;
			$pyjs.track={module:'pjBallot', lineno:46};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=46;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('nextSelection', function() {
			...
			var $add3,$add4;
			$pyjs.track={module:'pjBallot', lineno:51};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=51;
	...
	, 1, [null,null,['self'],['sender'],['keycode'],['modifiers']]);
		...
		$method = $pyjs__bind_method2('onKeyPress', function(sender, keycode, modifiers) {
			...
			$pyjs.track={module:'pjBallot', lineno:62};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=62;
	...
	, 1, [null,null,['self'],['sender'],['keycode'],['modifiers']]);
		...
		$method = $pyjs__bind_method2('onModuleLoad', function() {
			...
			var h,gp,l,panel;
			$pyjs.track={module:'pjBallot', lineno:73};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=73;
	...
	, 1, [null,null,['self'],['response'],['request_info']]);
		...
		$method = $pyjs__bind_method2('onRemoteError', function() {
			...
			$pyjs.track={module:'pjBallot', lineno:96};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=96;
	...
	$m['JSONService'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$pyjs.track={module:'pjBallot', lineno:100};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=100;
	...
	$m['RootPanelListener'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(Parent) {
			...
			$pyjs.track={module:'pjBallot', lineno:104};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=104;
	...
	, 1, ['args',['kwargs'],['self'],['Parent']]);
		...
		$method = $pyjs__bind_method2('onKeyDown', function(sender, keyCode, modifiers) {
			...
			$pyjs.track={module:'pjBallot', lineno:113};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pjBallot';
			$pyjs.track.lineno=113;
