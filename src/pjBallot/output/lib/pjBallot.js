...
$pyjs.loaded_modules['pjBallot'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onRemoteResponse', function(response, request_info) {
			...
			$m['sampleBallot'].currObj = $p['getattr']($p['getattr']($m['sampleBallot'], 'race'), 'selectionList').__getitem__(0);
	...
	$m['JSONService'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			(function(){try{try{$pyjs.in_try_except += 1;
			return $m['JSONProxy']['__init__'](self, 'http://10.0.22.106/test-service/', (function(){try{try{$pyjs.in_try_except += 1;
