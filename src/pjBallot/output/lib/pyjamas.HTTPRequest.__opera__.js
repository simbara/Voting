...
$pyjs.loaded_modules['pyjamas.HTTPRequest'] = function (__mod_name__) {
	...
	$m.__track_lines__[23] = 'pyjamas.HTTPRequest.py, line 6:\n    from __pyjamas__ import JS ... class HTTPRequest(object):';
	...
	$m.__track_lines__[31] = 'pyjamas.HTTPRequest.py, line 31:\n    ';
	...
	$m.__track_lines__[37] = 'pyjamas.HTTPRequest.py, line 37:\n    returnxml, content_type, headers)';
	...
	$m.__track_lines__[46] = 'pyjamas.HTTPRequest.py, line 46:\n    ';
	...
	$m.__track_lines__[124] = 'pyjamas.HTTPRequest.py, line 20:\n    self.content_type, self.headers) ... def asyncImpl(self, method, user, pwd, url, postData, handler,';
	...
	, 1, [null,null,['self'],['url']]);
		...
		$method = $pyjs__bind_method2('asyncImpl', function(method, user, pwd, url, postData, handler, returnxml, content_type, headers) {
			...
			var hval,$iter1_iter,localHandler,base64,$iter1_array,$iter1_nextval,$and4,$and5,$and6,xmlHttp,$iter1_type,h,$pyjs_try_err,$pyjs__trackstack_size_2,$iter1_idx,onreadystatechange;
			...
			onreadystatechange = function(evnt) {
				...
				$pyjs.track={module:'pyjamas.HTTPRequest',lineno:36};$pyjs.trackstack.push($pyjs.track);
				$pyjs.track.module='pyjamas.HTTPRequest';
				$pyjs.track.lineno=36;
